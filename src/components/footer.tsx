...
export function FirstFooter() {
  return (
    <div className="bg-[url(../../public/background.webp)] bg-cover bg-no-repeat flex flex-col justify-center items-center py-16 gap-7">
      <h2 className="font-bold text-4xl text-white">Just A Click Away From Enhancing Your Links Today!</h2>
      <Link href="/signup">
        <button
          type="button"
          title="get started"
...
const SocialIcon = ({ svgPath, width, height, alt }) => (
  <li>
...
export function SecondFooter() {
  return (
    <section className="bg-VeryDarkBlue flex text-white px-32 justify-between pt-9 pb-10">
      <div>
        <Link href="/">
